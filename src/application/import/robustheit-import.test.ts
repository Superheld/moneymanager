...
function roh(over: Partial<RohUmsatz> = {}): RohUmsatz {
  return {
    ...
    kontoIban: "DE93999999990000000001", ...over,
  };
}
...
describe("umsaetzeUebernehmen — nebenläufiger Import", () => {
  ...
  it("legt bei zwei parallelen Übernahmen derselben Datei nur einen Umsatz an", async () => {
    ...
    const eingabe: UebernahmeEingabe = {
      ...
      konten: [{ quelleKey: "DE93999999990000000001", kontoId: "konto-1" }],
    };
...
describe("kontoMatchVorschlag — IBAN-Schreibweisen", () => {
   ...
   * ERWARTET: „DE93999999990000000001" und „DE93 9999 9999 0000 0000 01" sind dasselbe Konto
  ...
  it("gruppiert dieselbe IBAN unabhängig von Leerzeichen und Groß-/Kleinschreibung", () => {
    const matches = kontoMatchVorschlag(
      [
        roh({ kontoIban: "DE93999999990000000001", kontoName: "Girokonto" }),
        roh({ kontoIban: "DE93 9999 9999 0000 0000 01", kontoName: "Girokonto" }),
        roh({ kontoIban: "de93999999990000000001", kontoName: "Girokonto" }),
      ],
      [],
    );
    ...
    await umsaetzeUebernehmen(
      {
        quelle: "finanzguru",
        zeitpunkt: "2026-01-06T10:00:00Z",
        rohUmsaetze: [roh({ kontoIban: "DE93999999990000000001" }), roh({ kontoIban: "DE93 9999 9999 0000 0000 01", betrag: -600 })],
        konten: [
          { quelleKey: "DE93999999990000000001", neu: { bezeichnung: "Giro", typ: "Giro", iban: "DE93999999990000000001" } },
          { quelleKey: "DE93 9999 9999 0000 0000 01", neu: { bezeichnung: "Giro", typ: "Giro", iban: "DE93999999990000000001" } },
        ],
      },
      deps,
    );
