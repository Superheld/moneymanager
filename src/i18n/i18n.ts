...
const de = {
  ...
  toepfe: {
    ...
    keinKonto: "Erst ein Konto unter Verwaltung → Konten anlegen.",
  ...
  konten: {
    ...
    neue: {
      titel: "Neu von der Bank ({{n}})",
      untertitel: "Abgerufen und noch nicht bestätigt — erst danach zählen sie im Saldo",
      alleBestaetigen: "{{n}} bestätigen",
      bestaetigen: "bestätigen",
      verwerfen: "verwerfen",
      laeuft: "läuft …",
      kategorieAendern: "Kategorie ändern",
      ...
      quelle: {
        ...
        festlegung: "durch deine Festlegung",
        umbuchung: "als Umbuchung erkannt",
        remapping: "aus der Quelle übernommen",
    ...
    abruf: {
      ...
      weiterInInbox: "Was neu ist, liegt in der Import-Inbox und wartet dort auf die Durchsicht.",
    },
    anlegen: {
      titel: "Konto anlegen",
...
const en: typeof de = {
  ...
  toepfe: {
    ...
    keinKonto: "Create an account under Management → Accounts first.",
  ...
  konten: {
    ...
    neue: {
      titel: "New from the bank ({{n}})",
      untertitel: "Retrieved and not confirmed yet — they count towards the balance only after that",
      alleBestaetigen: "Confirm {{n}}",
      bestaetigen: "confirm",
      verwerfen: "discard",
      laeuft: "working …",
      kategorieAendern: "Change category",
      ...
      quelle: {
        ...
        festlegung: "by your rule",
        umbuchung: "detected as a transfer",
        remapping: "taken from the source",
        manuell: "chosen by you",
      },
    },
    ...
    abruf: {
      ...
      weiterInInbox: "Anything new is waiting in the import inbox for review.",
    },
    anlegen: {
      titel: "Add account",
