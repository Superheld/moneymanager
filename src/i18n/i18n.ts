...
const de = {
  ...
  fehler: {
    ...
    ziel: { groesserNull: "Das Ziel muss größer als 0 sein." },
    frist: { groesserNull: "Die Frist (Monate) muss größer als 0 sein." },
    ruecklage: {
      zielOderRate:
        "Eine Rücklage hat entweder ein Ziel mit Frist oder eine freie Rate — nicht beides und nicht keins von beidem.",
      datumUngueltig: "Bitte ein gültiges Datum angeben.",
    },
  ...
  shell: {
    ...
    menueOeffnen: "Navigation öffnen",
    menueSchliessen: "Navigation schliessen",
  ...
  ausblick: {
    ...
    spalteIst: "gebucht",
    bleibt: "Bleibt übrig",
    bleibtErklaerung: "Einnahmen minus Verträge und Budgets",
    statusOffen: "offen",
    zeile: {
      einnahmen: "Einnahmen",
      vertraege: "Verträge",
  ...
  uebersicht: {
    titel: "Übersicht",
    untertitel: "Wie du gerade dastehst — dieser Monat und die beiden nächsten, über die verfügbaren Konten",
    fehlerDb: "Laden geht nur in der Desktop-App (tauri dev).",
    bedarfTitel: "Da ist etwas zu tun",
    bedarfUntertitel: "Konten, die bis zum {{bis}} ins Minus laufen",
    bedarfSicher: "sicher",
  ...
  ruecklagen: {
    loeschenFolgen: "Die Rücklage verschwindet samt ihrer monatlichen Rate. Buchungen, die zu ihr gehörten, bleiben — sie hängen an ihrer Kategorie, nicht an ihr.",
    titel: "Rücklagen",
    untertitel: "Was du zurücklegst für das, was noch kommt — und was es dich monatlich kostet",
    ruecklage: "Rücklage",
    kpiAnzahl: "Rücklagen",
    kpiZielwert: "Ziele gesamt",
    kpiProMonat: "Rate / Monat",
    kpiSoll: "Soll heute",
    kpiTatsaechlich: "Tatsächlich da",
    kpiDeckung: "Deckungsgrad",
    erklaerung:
      "Eine Rücklage hat entweder ein <b>Ziel mit Frist</b> (Waschmaschine, Auto, Urlaub in zwölf Monaten) — daraus ergibt sich die Monatsrate und der Betrag, der heute beisammen sein sollte — oder nur eine <b>freie Rate</b> für Ungewisses. Nennst du das Konto, auf dem das Geld liegt, wird die Rechnung gegen den <b>echten Kontostand</b> abgeglichen.",
    leer: "Noch keine Rücklagen. Leg deine erste an.",
    rate: "Rate",
    proMonatSuffix: "/Mt",
    pillNurRechnung: "ohne Konto",
    pillFrei: "frei",
    hinweisOhneKonto:
      "Keine Rücklage nennt bisher ein Konto — angezeigt wird nur die Rechnung. Trag beim Bearbeiten das Konto ein, auf dem das Geld liegt, dann siehst du auch, wie viel davon wirklich da ist.",
    bearbeiten: "bearbeiten",
    loeschen: "löschen",
    ausbuchen: "ausgebucht",
    fortschrittLabel: "Soll heute / Ziel",
    freiAufgelaufen: "aufgelaufen seit Beginn: {{betrag}}",
    gedecktDurch: "davon da auf {{konto}}",
    flussTitel: "Was diesen Monat zurückgelegt wird",
    flussUntertitel: "Von den liquiden Mitteln auf Rücklagen- und Vorsorgekonten",
    flussBedarf: "Bedarf",
    flussPlan: "eingerichtet",
    flussIst: "geflossen",
    flussOhnePlan:
      "Es ist noch keine Umbuchung eingerichtet. Ein Vertrag der Art „Umbuchung\" bucht regelmäßig von einem liquiden Konto auf ein Rücklagenkonto — und wird dann auch als geflossen erkannt.",
    mindestTitel: "Mindestrücklage (Faustformel)",
    mindestHerleitung: "drei Monats-Vertragseinnahmen ({{einnahmen}} im Monat). Reine Information — nichts wird daran gemessen.",
    ausbuchungenTitel: "Schon ausgebucht",
    ausbuchungenUntertitel: "Wofür Rücklagen bisher gebraucht wurden",
    ausgebuchtWeg: "(Rücklage gelöscht)",
    mitBuchung: "mit Buchung verknüpft",
    modalAusbuchen: "Rücklage ausbuchen",
    ausbuchenNeustart: "Startet danach neu — der Kauf selbst wird ganz normal gebucht",
    ausbuchenEnde: "Danach ist sie erledigt — der Kauf selbst wird ganz normal gebucht",
    feldAusDatum: "Datum",
    feldAusBetrag: "Ausgegeben",
    feldAusBuchung: "Buchung",
    feldAusBuchungHinweis: "optional — die verknüpfte Buchung zählt danach gegen kein Budget",
    buchungKeine: "keine Buchung",
    feldKonto: "Rücklagenkonto",
    feldKontoHinweis: "optional — wo das Geld tatsächlich liegt",
    kontoKeins: "kein Konto",
    feldNeuesZielHinweis: "Ziel für den nächsten Zyklus — Preise steigen",
    modalBearbeiten: "Rücklage bearbeiten",
    modalAnlegen: "Rücklage anlegen",
    modalUntertitel: "Ziel ÷ Frist → Monatsrate, oder die Rate direkt",
    speichern: "Speichern",
    abbrechen: "Abbrechen",
    feldBezeichnung: "Wofür",
    feldBezeichnungPlatzhalter: "z. B. Waschmaschine, Urlaub",
    feldForm: "Form",
    form: { ziel: "Ziel mit Frist", rate: "freie Rate" },
    formHinweis: {
      ziel: "die Rate rechnet sich; nach dem Ausbuchen fängt sie von vorn an",
      rate: "läuft ohne Ziel weiter; nach dem Ausbuchen ist sie erledigt",
    },
    feldZiel: "Ziel",
    feldZielHinweis: "was am Ende beisammen sein soll",
    feldFrist: "Frist (Monate)",
    feldFristHinweis: "z. B. 96 = 8 Jahre",
    feldRate: "Rate im Monat",
    feldRateHinweis: "was du monatlich zurücklegst",
    feldBeginn: "Beginn",
  },
  kategoriePicker: {
  ...
  konten: {
    ...
    loeschenHinweis: "Löschen: geht nur, solange nichts am Konto hängt — sonst sagt die Rückfrage, was im Weg ist.",
    endgueltigHinweis: "Endgültig löschen: nimmt die Buchungen und die Belege der Bank mit. Nicht umkehrbar.",
  ...
  vertraege: {
    ...
    art: {
      abo: "Abo — kündbar",
      dauervertrag: "Dauervertrag — Arbeit, Miete",
      umbuchung: "Umbuchung — von Konto zu Konto",
    },
    artKurz: { dauervertrag: "Dauervertrag", umbuchung: "Umbuchung" },
    artHinweis: {
      ...
      umbuchung: "eine Abmachung mit dir selbst — sie wird am Weg erkannt, nicht am Empfänger",
    },
    feldZielkonto: "Zielkonto",
    feldZielkontoHinweis: "wohin umgebucht wird — daran wird die Zahlung wiedererkannt",
...
const en: typeof de = {
  ...
  fehler: {
    ...
    ziel: { groesserNull: "The target must be greater than 0." },
    frist: { groesserNull: "The deadline (months) must be greater than 0." },
    ruecklage: {
      zielOderRate:
        "A reserve has either a target with a deadline or a free rate — not both and not neither.",
      datumUngueltig: "Please enter a valid date.",
    },
  ...
  shell: {
    ...
    menueOeffnen: "Open navigation",
    menueSchliessen: "Close navigation",
  ...
  ausblick: {
    ...
    spalteIst: "posted",
    bleibt: "Left over",
    bleibtErklaerung: "Income minus contracts and budgets",
    statusOffen: "open",
    zeile: {
      einnahmen: "Income",
      vertraege: "Contracts",
  ...
  uebersicht: {
    titel: "Overview",
    untertitel: "Where you stand right now — this month and the next two, across your available accounts",
    fehlerDb: "Loading only works in the desktop app (tauri dev).",
    bedarfTitel: "Something needs doing",
    bedarfUntertitel: "Accounts going negative before {{bis}}",
  ...
  ruecklagen: {
    loeschenFolgen: "The reserve disappears along with its monthly rate. Entries that belonged to it stay — they hang off their category, not off it.",
    titel: "Reserves",
    untertitel: "What you set aside for what is still to come — and what it costs you per month",
    ruecklage: "Reserve",
    kpiAnzahl: "Reserves",
    kpiZielwert: "Total targets",
    kpiProMonat: "Rate / month",
    kpiSoll: "Target today",
    kpiTatsaechlich: "Actually there",
    kpiDeckung: "Coverage",
    erklaerung:
      "A reserve either has a <b>target with a deadline</b> (washing machine, car, holiday in twelve months) — the monthly rate and the amount that should be put aside by today follow from it — or just a <b>free rate</b> for the uncertain. Name the account the money sits on and the calculation is reconciled against the <b>real account balance</b>.",
    leer: "No reserves yet. Add your first one.",
    rate: "Rate",
    proMonatSuffix: "/mo",
    pillNurRechnung: "no account",
    pillFrei: "free",
    hinweisOhneKonto:
      "No reserve names an account yet — only the calculation is shown. Edit one and pick the account the money sits on to see how much of it is really there.",
    bearbeiten: "edit",
    loeschen: "delete",
    ausbuchen: "used up",
    fortschrittLabel: "Target today / Goal",
    freiAufgelaufen: "accumulated since the start: {{betrag}}",
    gedecktDurch: "of that on {{konto}}",
    flussTitel: "Set aside this month",
    flussUntertitel: "From liquid funds to reserve and provision accounts",
    flussBedarf: "Needed",
    flussPlan: "set up",
    flussIst: "moved",
    flussOhnePlan:
      "No transfer is set up yet. A contract of the kind „transfer\" moves money regularly from a liquid account to a reserve account — and is then recognised as having flowed.",
    mindestTitel: "Minimum reserve (rule of thumb)",
    mindestHerleitung: "three months of contract income ({{einnahmen}} per month). Information only — nothing is measured against it.",
    ausbuchungenTitel: "Already used",
    ausbuchungenUntertitel: "What reserves have been spent on so far",
    ausgebuchtWeg: "(reserve deleted)",
    mitBuchung: "linked to an entry",
    modalAusbuchen: "Use up reserve",
    ausbuchenNeustart: "Restarts afterwards — the purchase itself is booked as usual",
    ausbuchenEnde: "Done afterwards — the purchase itself is booked as usual",
    feldAusDatum: "Date",
    feldAusBetrag: "Spent",
    feldAusBuchung: "Entry",
    feldAusBuchungHinweis: "optional — the linked entry no longer counts against any budget",
    buchungKeine: "no entry",
    feldKonto: "Reserve account",
    feldKontoHinweis: "optional — where the money actually sits",
    kontoKeins: "no account",
    feldNeuesZielHinweis: "target for the next cycle — prices go up",
    modalBearbeiten: "Edit reserve",
    modalAnlegen: "Add reserve",
    modalUntertitel: "Target ÷ deadline → monthly rate, or the rate directly",
    speichern: "Save",
    abbrechen: "Cancel",
    feldBezeichnung: "What for",
    feldBezeichnungPlatzhalter: "e.g. washing machine, holiday",
    feldForm: "Kind",
    form: { ziel: "target with deadline", rate: "free rate" },
    formHinweis: {
      ziel: "the rate is calculated; after using it up it starts over",
      rate: "runs on without a target; after using it up it is done",
    },
    feldZiel: "Target",
    feldZielHinweis: "what should be there in the end",
    feldFrist: "Deadline (months)",
    feldFristHinweis: "e.g. 96 = 8 years",
    feldRate: "Rate per month",
    feldRateHinweis: "what you set aside monthly",
    feldBeginn: "Start",
  },
  kategoriePicker: {
  ...
  konten: {
    ...
    loeschenHinweis: "Delete: only possible while nothing belongs to the account — otherwise the prompt says what is in the way.",
    endgueltigHinweis: "Delete permanently: takes the entries and the bank receipts with it. Not reversible.",
    gefuehrt: "kept",
    zustandTitel: "State",
  ...
  vertraege: {
    ...
    feldArt: "Kind",
    art: {
      abo: "Subscription — cancellable",
      dauervertrag: "Standing contract — work, rent",
      umbuchung: "Transfer — account to account",
    },
    artKurz: { dauervertrag: "Standing", umbuchung: "Transfer" },
    artHinweis: {
      ...
      umbuchung: "an arrangement with yourself — recognised by the route, not the payee",
    },
    feldZielkonto: "Target account",
    feldZielkontoHinweis: "where the money goes — the payment is recognised by this route",
