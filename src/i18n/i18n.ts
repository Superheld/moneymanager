...
const de = {
  ...
  konten: {
    ...
    neue: {
      titel: "Zu prüfen ({{n}})",
      untertitel: "Abgerufene Zeilen mit Dublettenverdacht — sie zählen erst im Saldo, wenn du sie bestätigst",
      nurWeggelegtTitel: "Weggelegte Bankzeilen",
      nurWeggelegtUntertitel: "Nichts zu prüfen — hier steht nur, was du beiseitegelegt hast",
      bestaetigen: "doch buchen",
      verwerfen: "verwerfen",
...
const en: typeof de = {
  ...
  konten: {
    ...
    neue: {
      titel: "Needs a decision ({{n}})",
      untertitel: "Retrieved rows suspected of being duplicates — they count towards the balance only once you confirm them",
      nurWeggelegtTitel: "Set-aside bank rows",
      nurWeggelegtUntertitel: "Nothing to review — this only lists what you set aside",
      bestaetigen: "post anyway",
      verwerfen: "discard",
